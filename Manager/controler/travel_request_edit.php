...
//=============================================================================	
	...
	if(isset($_POST['update_btn'])){
		...
		$user = [	
			...
			$id=$_GET['id'];
			$status = TravelRequestUpdateData($user,$id);
...
//==================================================================================
			$data = getUserTravelRequestById($id);
		...
		<tr>
			...
			<td colspan="2" align="center">
				<table align="center">
					<tr>
						<td>
							<form method="post" action="create_travel_request.php?id=<?php echo $id;?>">
								<fieldset>
									<h2>Update Travel Request</h2>
									<hr>
