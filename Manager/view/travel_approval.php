							...
							foreach ($result as $key => $value) {
								echo "
									<tr>
										...
										<td>{$value['status']}</td>
										<td>
											<a href='../controler/travel_request_edit.php?id=$value[id]'>Update</a>
										</td>
										<td>
											<a href='../controler/travel_request_delete.php?id=$value[id]'>Delete</a>
										</td>
									</tr>
								";
							}
